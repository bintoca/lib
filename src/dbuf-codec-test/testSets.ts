...
const parseTests = [
    ...
    [[tca(1, r.parse_varint, r.parse_varint, aa(3, 7, 8, 9)), wbs(1, 2)], choice(bit_val(1, 2))],
    [[tca(1, r.parse_varint, r.nonexistent, 3), wbs(1, 3)], choice(bit_val(1, 3))],
    [[tcsa(1, r.parse_varint, r.parse_varint, asa(3, 7, 8, 9)), wbs(1, 2)], choice_shared(bit_val(1, 2))],
    [[tcsa(1, r.parse_varint, r.nonexistent, 3), wbs(1, 3)], choice_shared(bit_val(1, 3))],
    [[tm(0)], map()],
