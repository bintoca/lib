...
test.each([
    ...
    [[r.bind, r.type_struct, r.integer_unsigned, r.bit_size, 7, r.bit_size, 7, r.bit_size, 23, r.bit_size, 47, r.integer_unsigned, r.bit_size, 7, r.end_scope, 3, u8, u8, u8, 4, u8], { type: struct_sym, items: [3, 1, 2, 0x030401, { type: bits_sym, items: [0x02030401, 0x0203, 16] }, 4, 1] }],
])('parse_strip(%#)', (i, o) => {
    const w = writer(i)
    try {
        const s = parse(w)
