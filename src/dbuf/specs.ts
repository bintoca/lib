...
import { ParseMode, Node, bit_val, val, littleEndianPrefix, magicNumberPrefix, createEncoder, finishWrite } from '@bintoca/dbuf/codec'
import { readFileSync } from 'fs'
import * as pa from 'path'
import { writeNode, type_array, type_choice, choice, array, root, type_map, map, parse_bit_size, parse_type_data_immediate, align, type_array_bit, array_bit, type_array_fixed, array_fixed, type_array_chunk, array_chunk, chunk, type_choice_shared, type_choice_select, choice_select, parse_align, choice_shared, string, type_choice_array, type_choice_shared_array, type_optional, parse_type_data, trimBuffer, bytes } from './pack'

export type RegistryLink = { rid: r }
...
export const registryEnum = parseEnum('./dbuf/registryEnum.ts', 'r')
